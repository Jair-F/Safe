...
public:
    lock_screen(UI::MainWindow *_main_window) : UI::Window(_main_window), _button(this, upper_left, lower_right, this),
                                                _button2(this, {this->_get_display()->getDisplayYSize() - 100, this->_get_display()->getDisplayXSize() - 35}, {this->_get_display()->getDisplayYSize() - 1, this->_get_display()->getDisplayXSize() - 1}, this),
                                                ...
                                                ch_box(this, {50, 150}, 25, 25, this)
    {
        ...
        ch_box.check_sign_color = VGA_RED;
