...
public:
    ...
    */
    Lock(const unsigned short _lock_timer, bool lock_state = false, bool _allow_unlocking = true) : unlocking_allowed(_allow_unlocking),
        locked(lock_state), lock_timer(_lock_timer), unlock_time_point(0) { }
    ...
    */
    bool is_locked() { return this->locked; }
