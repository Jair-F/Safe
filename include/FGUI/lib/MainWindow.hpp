...
namespace FGUI
{
    ...
    public:
        ...
        /**
         * @details makes that the focus cant be changed until unfreeze_focus() is called
        ...
        /**
         * @details unfreezes the focus that widget can gain again the focus
         */
        ...
        /**
         * @details send the backspace command to the focused widget
         */
        void send_backspace();
        /**
         * @details send enter command to the focused widget
         */
        void send_enter();
    ...
    protected:
         ...
         * @details check if the given position is in the physical display - not the positions for the windows to get their size.
         */
    ...
    private:
        bool focus_frozen;         ///< @brief true one widget has the focus and we are not allowed to change the focus
        Widget *focused_widget;    ///< @brief pointer to the actual focused widget - if there is no it is nullptr
        WindowBase *active_window; ///< @brief pointer to the active_window - if there is no it is nullptr

        UTFT *display;  ///< @brief widgets and windows can get this pointer to draw on display and get information
        URTouch *touch; ///< @brief widgets and windows can get this pointer to draw on display and get information

        /**
         * @brief size of the "normal windows" which are shown on the main_window
         * the windows grab this values in their window-constructor to set their size
         *
         * @{
         */
        ...
        /**
         * @brief sleep timer in seconds
         * @details seconds which have to pass until the display falls in a sleep mode -
         * the display will turn black until the next touch
         */
        uint16_t fall_asleep_timer = 60;
        /**
         * @brief last time point the user interacted with the display/keypad
         */
        uint32_t last_interact_time_pt = 0;
        bool in_sleep_mode = false; ///< @brief true if in sleep_mode=black screen
    };
