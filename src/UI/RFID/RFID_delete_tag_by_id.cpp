...
RFID_delete_tag_by_id::RFID_delete_tag_by_id(FGUI::WindowBase *_parent_window) : Window(_parent_window),
                                                                                 ...
                                                                                 tag_id_label(this, {60, 60}, 60, "tag ID:", Retro8x16),
                                                                                 tag_id_to_remove(this, {160, 55}, 80, 40, this, FGUI::InputField<2, RFID_delete_tag_by_id>::IN_INPUT_TYPE::IN_TEXT),
